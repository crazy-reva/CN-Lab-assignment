...
var streamWorker = new Worker("/worker.76c2667f.js");
function captureVideo(_x) {
  return _captureVideo.apply(this, arguments);
}
function _captureVideo() {
  _captureVideo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(videoInput) {
    var stream;
...
var startCapture = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(track, settings) {
    var ts, processor, inputStream, generator, outputStream, ssrcArr, ssrc, options;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          // Start capturing frames at 30 fps
          ts = track.getSettings();
          ...
          ssrcArr = new Uint8Array(1);
          window.crypto.getRandomValues(ssrcArr);
          ssrc = ssrcArr[0]; //   const captureStream = new MediaStream();
          ...
          streamWorker.addEventListener("message", function (info) {
            console.log("aaaa", info);
            var i = info.data;
            console.log(info.type);
            if (i.type === "data") {
              console.log("dataaa");
              var blob = new Blob([i.data], {
                type: "video/mp4"
              });
              ...
              var file = formData.getAll("segment");
              var outputFileName = formData.get("segment").name;
              // console.log(file);
  ...
  return function startCapture(_x2, _x3) {
...
function display(videoFile, videoEl) {
  ...
  var newObjectUrl = URL.createObjectURL(videoFile);

  // URLs created by `URL.createObjectURL` always use the `blob:` URI scheme: https://w3c.github.io/FileAPI/#dfn-createObjectURL
  var oldObjectUrl = videoEl.currentSrc;
...
var init = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var settings, videoInput, stream, track, capabilties;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 4;
          return captureVideo(videoInput);
        case 4:
          stream = _context2.sent;
          track = stream.getVideoTracks()[0]; //  const imageCapture=new ImageCapture(track);
          //  imageCapture.
          capabilties = track.getCapabilities();
...
init();
},{"./worker.js":[["worker.76c2667f.js","src/js/worker.js"],"worker.76c2667f.js.map","src/js/worker.js"]}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
